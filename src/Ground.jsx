        ...
        <>
            ...
            >
                ...
                <MeshReflectorMaterial
                    ...
                    mixBlur={3} // How much blue mixes with the surface roughness (default=1)
                    mixStrength={30} // Strength of the reflections
                    mixContrast={1} // Contrast of the reflections
                    resolution={1024} // Off-buffer resolution, lower=faster, higher=better quality, slower
                    mirror={0} // Mirror environment, 0 = texture colors, 1 = pick up environment colors
                    depthScale={0} // Scale the depth factor (0 = no depth, default = 0)
                    minDepthThreshold={0.9} // Lower edge for the depthTexture interpolation (default = 0)
                    maxDepthThreshold={1} // Upper edge for the depthTexture interpolation (default = 1)
                    depthToBlurRatioBias={0.25} // Adds a bias to the depthTexture before calculating the blur amount
                    debug={0}
                    reflectorOffset={0.02} // Offset the reflection to avoid z-fighting
                />
            </mesh>
        </>
    );
